...
import { IWalkerApplicationMessage, IUser } from '../../models/api';
import * as moment from 'moment';

export interface IWalkerApplicationMessageComponent {
  getMessageDateFromNow(date): string,
  isMessageOwner(): boolean
}

@Component({
  selector: 'app-walker-application-message',
  template: `
...
export class WalkerApplicationMessageComponent implements OnInit, IWalkerApplicationMessageComponent{
  @Input() message: IWalkerApplicationMessage;
